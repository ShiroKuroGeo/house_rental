...
#viewer_modal .btn-close{position: absolute;z-index: 999999;/*right: -4.5em;*/background: unset;color: white;border: unset;font-size: 27px;top: 0;}
...
<script>
 ...
 window.viewer_modal = function($src = ''){
    ...
    t = t[1]
    if(t =='mp4'){
      var view = $("<video src='"+assets/uploads/this.gif+"' controls autoplay></video>")
    }else{
...
#example1 {
  ...
  padding: 25px;
  background: url(assets/uploads/this.gif);
